...
namespace Language_es {
  ...
  LSTR WELCOME_MSG                        = MACHINE_NAME _UxGT(" Reportandose a servicio");
  LSTR MSG_YES                            = _UxGT("SI");
  LSTR MSG_NO                             = _UxGT("NO");
  LSTR MSG_BACK                           = _UxGT("Atrás");
  LSTR MSG_MEDIA_ABORTING                 = _UxGT("Cancelando...");
  LSTR MSG_MEDIA_INSERTED                 = _UxGT("SD insertado");
  LSTR MSG_MEDIA_REMOVED                  = _UxGT("SD retirado");
  ...
  LSTR MSG_INFO_SCREEN                    = _UxGT("Pantalla de Info.");
  ...
  LSTR MSG_MANUAL_DEPLOY                  = _UxGT("Colocar Sonda Z");
  LSTR MSG_MANUAL_STOW                    = _UxGT("quitar Sonda Z");
  ...
  LSTR MSG_BRICKOUT                       = _UxGT("Bloques");
  LSTR MSG_INVADERS                       = _UxGT("Marcianitos");
  LSTR MSG_SNAKE                          = _UxGT("Sn4k3");
  LSTR MSG_MAZE                           = _UxGT("laberinto");
